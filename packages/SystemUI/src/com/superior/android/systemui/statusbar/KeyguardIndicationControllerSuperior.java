package com.superior.android.systemui.statusbar;
...
@SysUISingleton
public class KeyguardIndicationControllerSuperior extends KeyguardIndicationController {
    ...
    private SuperiorKeyguardCallback mUpdateMonitorCallback;

    private class SuperiorKeyguardCallback extends KeyguardIndicationController.BaseKeyguardCallback {
        private SuperiorKeyguardCallback() {
            super();
        }
    ...
    @Inject
    public KeyguardIndicationControllerSuperior(
            Context context,
    ...
    public final KeyguardUpdateMonitorCallback getKeyguardCallback() {
        if (mUpdateMonitorCallback == null) {
            mUpdateMonitorCallback = new SuperiorKeyguardCallback();
        }
